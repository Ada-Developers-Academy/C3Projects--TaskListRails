...
people = [
  { name: "Lila", occupation: "Student", favorite_color: "blue" },
  { name: "Casey", occupation: "Project Manager", favorite_color: "green" },
  { name: "Chad", occupation: "FX Artist", favorite_color: "orange" }
]
